...
namespace DotNetty.Codecs.Http
{
    ...
    public class EmptyHttpHeaders : HttpHeaders
    {
        ...
        private static List<ICharSequence> EmptyChars = new List<ICharSequence>();
        private static List<HeaderEntry<AsciiString, ICharSequence>> EmptyHeaders = new List<HeaderEntry<AsciiString, ICharSequence>>();

        public override long GetTimeMillis(AsciiString name, long defaultValue) => defaultValue;

        public override IList<ICharSequence> GetAll(AsciiString name) => EmptyChars;

        public override IList<HeaderEntry<AsciiString, ICharSequence>> Entries() => EmptyHeaders;
        ...
        private static HashSet<AsciiString> EmptyStrings = new HashSet<AsciiString>();
        public override ISet<AsciiString> Names() => EmptyStrings;
