...
namespace DotNetty.Codecs.Http.Cors
{
    ...
    public sealed class CorsConfig
    {
        ...
        public ISet<ICharSequence> ExposedHeaders() => this.exposeHeaders;

        public bool IsCredentialsAllowed => this.allowCredentials;

        public long MaxAge => this.maxAge;

        public ISet<HttpMethod> AllowedRequestMethods() => this.allowedRequestMethods;

        public ISet<AsciiString> AllowedRequestHeaders() => this.allowedRequestHeaders;
